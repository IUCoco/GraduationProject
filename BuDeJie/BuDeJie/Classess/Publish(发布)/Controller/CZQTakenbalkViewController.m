...
- (void)post {
    ...
    BOOL isFirstPublishTB = [[NSUserDefaults standardUserDefaults] objectForKey:@"isFirstPublishTB"];
    ...
    if (isFirstPublishTB) {//首次发布成功后之后发布进入该判断
    ...
    //添加首次发布成功标记
    [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"isFirstPublishTB"];
