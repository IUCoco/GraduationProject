...
//处理按钮点击
- (void)dealTitleBtnClick:(CZQTitleButton *)titleBtn{
...
- (void)setUpNavBar{
    //左边按钮
    UIImage *leftNorImage = [UIImage imageNamed:@""];
    UIImage *leftHighImage = [UIImage imageNamed:@""];
    ...
    //右边按钮
    UIImage *rightNorImage = [UIImage imageNamed:@""];
    UIImage *rightHighImage = [UIImage imageNamed:@""];
    //调用UIBarButtonItem分类直接生成需要的buttonItem
